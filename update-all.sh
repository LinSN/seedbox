...
/usr/local/bin/docker-compose -f /home/linsn/seedbox/docker-compose-traefik.yml -f /home/linsn/seedbox/docker-compose.yml pull
echo "[$0] ***** Recreating containers if required... *****"
/usr/local/bin/docker-compose -f /home/linsn/seedbox/docker-compose-traefik.yml -f /home/linsn/seedbox/docker-compose.yml up -d --remove-orphans
